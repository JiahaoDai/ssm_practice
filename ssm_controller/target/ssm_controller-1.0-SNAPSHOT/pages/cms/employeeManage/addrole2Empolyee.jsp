    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form action="${pageContext.request.contextPath}/user/addrole2employee">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">用户表</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach items="${employee.roles}" var="role" varStatus="sr">
                                            <tr>
                                                <td>
                                                    <input type="radio" value="${employee.id}" name="uid">
                                                </td>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach items="${otherRoles}" var="otherRole" varStatus="s">
                                            <tr>
                                                <td>
                                                    <input type="checkbox" name="rid" value="${otherRole.id}">
                                                </td>
