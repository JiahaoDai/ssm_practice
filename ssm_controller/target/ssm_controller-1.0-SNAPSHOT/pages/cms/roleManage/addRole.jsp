                    ...
                    <div class="col-md-6" style="margin-top: 20px; margin-left: 300px">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">新建角色</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="${pageContext.request.contextPath}/role/save" method="post">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">角色名称</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" name="roleName"
                                               placeholder="请输入新的角色名">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">角色描述</label>
                                        <input type="text" class="form-control" id="exampleInputPassword1" name="roleDesc"
                                               placeholder="请输入对新建角色的描述信息">
                                    </div>
                                </div>
                                <!-- /.card-body -->
