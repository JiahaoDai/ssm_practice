                ...
                success:function (userInfo) {
                    ...
                    for(var i = 0; i < stars.length; i++) {
                        ...
                        $.ajax({
                            ...
                            dataType:"json",
                            async: false,
                            success:function (starsSecond) {//这个查询出来的是我关注的人,因为无法使用递归，或者是我不会这个递归
                                content += '<div class="user-status">\n' +
                                    '                                            <div class="user-fansNum">\n' +
                                    '                                                粉丝数:'+starsSecond.fans.length+'\n' +
                                    '                                            </div>\n' +
                                    '                                            <div class="user-starsNum">\n' +
                                    '                                                关注的人:'+starsSecond.stars.length+'\n' +
                                    '                                            </div>\n' +
                                    '                                        </div>\n' +
                                    '                                    </div>\n' +
                                    '\n' +
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">我的关注</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
